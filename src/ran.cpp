...
string g_ran_ip_addr = "172.18.0.2";
string g_trafmon_ip_addr = "172.18.0.2";
string g_mme_ip_addr = "172.18.0.4";
...
bool Ran::authenticate() {
	...
	autn_num = res + 1;
	cout<<"generated autn number is "<<autn_num<<endl;
	cout<<"extracted xautn_num is "<<xautn_num<<endl;
